...
Deyim (statements) ve ifadeler (expressions) arasındaki farkı daha iyi anlamak için JavaScript Temelleri modülündeki ["Deyim vs. İfadeler"](/js-temelleri/js-temelleri) dersine bakabilirsin.
