...
- `||` **Operatöründen Kaçınma:** `||` operatörü beklemediğimiz durumlarda yedek değeri gösterebilir. Örneğin, verilen değer _falsy_ (yani `null`, `undefined`, `0`, `''` gibi) olduğunda yedek değeri kullanır.
